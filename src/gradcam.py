...
class CamExtractor():
    ...
    def forward_pass_on_convolutions(self, x):
        ...
        for module_pos, module in self.model.features._modules.items():
            x = module(x)  # Forward
            if (isinstance(self.target_layer, int) and int(module_pos) == self.target_layer) \
                    or module == self.target_layer:
...
class GradCam():
    ...
    def generate_cam(self, input_image, target_index=None, img_size=(224,224)):
        # Full forward pass
